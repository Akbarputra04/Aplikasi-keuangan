        ...
        <div class="container-fluid p-4">
          ...
          <div class="tab-content mt-4" id="myTabContent">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
              ...
              <div class="card shadow">
                <div class="card-header py-3">
                  <h1 class="m-0 font-weight-bold text-success text-center">Keuangan Masjid Miftahul Huda</h1>
                </div>
                <div class="card-body">
                  <div>
            ...
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
              ...
              <div class="card shadow">
                <div class="card-header py-3">
                  <h1 class="m-0 font-weight-bold text-success text-center">Keuangan takjil Masjid Miftahul Huda</h1>
                </div>
                <div class="card-body">
                  <div>
                    <table class="table table-bordered" id="dataTable1" class="display" style="width:100%" cellspacing="0">
                      <thead>
                        <tr>
                          <th>No</th>
                          <th>Nama</th>
            ...
            <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
              ...
              <div class="card shadow">
                <div class="card-header py-3">
                  <h1 class="m-0 font-weight-bold text-success text-center">Keuangan ramadhan Masjid Miftahul Huda</h1>
                </div>
                <div class="card-body">
                  <div>
                    <table class="table table-bordered" id="dataTable2" class="display" style="width:100%" cellspacing="0">
                      <thead>
                        <tr>
                          <th>No</th>
                          <th>Nama</th>
